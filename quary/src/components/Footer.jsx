    ...
    <div className="px-[16px] py-[32px] bg-black font-Yantramanav text-white">
          ...
          <div className="flex flex-col gap-[16px]">
            <div className="flex gap-[12px] items-center">
              <img
                src={LogoConfig.src}
                alt="logo"
                className="object-cover h-[70px] w-[90px]"
              />
              <h3 className="text-[24px] font-semibold ">Teejey Quary</h3>
            </div>
            <p className="lg:w-[596px] w-full text-[16px] leading-[22px] font-medium">
              Suba Mangalya is a trusted matrimony platform that blends
              tradition with technology to help you find your perfect match
              through verified profiles, personalized matches, and secure
              communication. Start your journey to lasting love today!
            </p>
          ...
          <div className="flex md:gap-[60px] gap-[32px] md:flex-row flex-wrap">
            <div className="flex flex-col gap-[8px]">
              ...
              <div className="flex flex-col gap-[12px]">
                ...
                <Link to="/">
                  <p className="hover:text-[#FF7318] text-nowrap">
                    How We Work
                  </p>
                </Link>
                <Link to="/">
      ...
      <div className="container mx-auto">
        <div className="flex md:flex-row flex-col justify-between  py-[10px]">
          <p className="text-[18px] text-white font-Manrope md:text-start text-center ">
            Copyright © 2024 Jeevathuvarakan.
          </p>
          <div className="flex md:flex-row  flex-col  md:gap-[16px] gap-[4px] items-center">
            <p className="text-[18px] text-white font-Manrope">
              Term of Services
            </p>
            <p className="text-[18px] text-white font-Manrope">
              Privacy Policy
