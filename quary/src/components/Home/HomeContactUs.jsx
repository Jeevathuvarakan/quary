			...
			<div className="px-[16px] py-[32px] font-Yantramanav">
				<div className="container mx-auto ">
					<div className="py-[10px] flex lg:flex-row flex-col gap-[24px] justify-between items-center">
						...
						<div className="flex flex-col gap-[20px] ">
							<h1 className="text-[#151515] capitalize lg:text-[32px] md:text-[24px] text-[16px] font-bold  w-full lg:leading-[58px]">
								Fill athe Form Below
							</h1>
							<form>
								<div className="flex flex-col gap-[18px]">
									<div className="flex gap-[20px]">
										<div className="mt-[20px]">
											...
											<input
												type="text"
												name="name"
												className="w-full h-[50px] bg-transparent border-2 border-solid border-[#ddd] outline-none p-[15px] text-[16px] bg-[#F7F7F7] text-[#333] mt-[8px]"
									...
									<div className="">
										...
										<textarea
											type="text"
											name="subject"
											className="w-full h-[120px]  bg-transparent border-2 border-solid border-[#ddd] outline-none p-[15px] text-[16px] text-[#333] mt-[8px]"
